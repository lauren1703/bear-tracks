...
# Fetch live events from Campus Groups and add to database
@app.route("/events/fetch/")
def fetch_events():
...
# Add user. Check if user is new and add to database
